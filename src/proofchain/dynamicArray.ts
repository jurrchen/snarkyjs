/**
 * From: https://github.com/gretzke/zkApp-data-types/blob/main/src/dynamicArray.ts
 * 
 * This is outdated, but nothing has been done for dynamic arrays
 * https://github.com/o1-labs/snarkyjs/issues/90
 */
...
export function DynamicArray<T>(type: Provable<T>, maxLength: number) {
